...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_left_ = it_.subscribe("/stereo/left/camera/image_raw", 1, &ImageConverter::imageCbLeft, this);
    image_sub_right_ = it_.subscribe("/stereo/right/camera/image_raw", 1, &ImageConverter::imageCbRight, this);
    image_pub_ = it_.advertise("/opencv_proc/output_video", 1);
